...
* 🌱 Mengembangkan **Point of Sale System** menggunakan Next.js.
* ✈️ Membangun platform **Tour & Travel** yang modern.
* 🧠 Riset implementasi **Support Vector Machine (SVM)** untuk prediksi kesehatan (Heart Failure Prediction).
* 🖥️ Bereksperimen dengan aplikasi desktop menggunakan **PyQt6** dan **Visual Basic**.

### ⚡ Fun Facts
* Saya suka mengulik konfigurasi jaringan (Cisco/Huawei/MikroTik) di waktu luang.
* Tertarik dengan Game Dev menggunakan **Godot Engine**.
